...
class VOptIPOPT:
    ...
    def sol_init(self):
        ...
        a_max = opt_config.getfloat('CAR_PARAMETER', 'a_max')  # [m/s²] Maximum Laongitudianl Acceleratio
        # max. lateral acceleration [m/s²]
        a_lat_max = opt_config.getfloat('CAR_PARAMETER', 'a_lat_max')  # [m/s²] Maximum Lateral Acceleration
        # max. slack angle [rad]
        ...
        k_br = self.sol_dict[self.key]['F_Z']
